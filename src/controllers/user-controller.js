...
const retrieve = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).send({ status: 200, user: user, message: "Succesfully Users Retrieved" });
    } catch {
...
const create = async (req, res) => {
    ...
    try {
        ...
        res.status(201).send({ status: 200, user: user, message: 'User created' });
    } catch {
...
const update = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).send({ status: 200, user: user, message: 'Updated user' });
    } catch (error) {
...
const deleteU = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).send({ status: 200, user: user, message: 'User Deleted' });
    } catch (error) {
        return res.status(500).send({ status: 500, message: error.message });
    }
};
